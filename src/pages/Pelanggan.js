...
function Pelanggan({
    ...
    return (
        <div style={{ backgroundColor: '#fff', color: '#1a1a1a', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
            ...
            {/* ==========================================================================
               ✨ 1. HERO SECTION (HANYA BAGIAN INI YANG DIGANTI LATAR BELAKANGNYA)
               ========================================================================== */}
            <div style={{
                // Memadukan warna asli pink #E91E8C dengan gambar mesin cetak agar tulisan tetap kontras
                ...
                color: '#fff',
                textAlign: 'center',
                padding: '60px 20px', // Menggunakan ukuran padding asli bawaan kamu
                position: 'relative',
                overflow: 'hidden'
            }}>
                <div style={{ fontSize: '48px', fontWeight: '800', letterSpacing: '-1px', marginBottom: '10px', textShadow: '0px 2px 6px rgba(0,0,0,0.3)' }}>
                    Elfitri Store
                </div>
                <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.85)', maxWidth: '500px', margin: '0 auto 20px auto', lineHeight: '1.4', textShadow: '0px 2px 4px rgba(0,0,0,0.3)' }}>
                    Ambil antrean cetak banner, stiker, dan custom merchandise tanpa perlu antre fisik di toko.
                </p>
                <a href="#ambil-antrean" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#fff', color: '#E91E8C', padding: '12px 24px', borderRadius: '50px', fontSize: '15px', fontWeight: '600', textDecoration: 'none' }}>
                    <i className="ti ti-user-plus"></i> Ambil Antrean Mandiri
                </a>
            </div>

            {/* ==========================================================================
               📦 BAGIAN KE BAWAH INI 100% SAMA SEPERTI KODE ASLI KAMU SEBELUMNYA
               ========================================================================== */}
            {/* 2. FITUR UNGGULAN TOKO */}
            <div style={{ padding: '48px 20px', maxWidth: '600px', margin: '0 auto' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '20px' }}>
                    <button
                        ...
                        style={{ background: 'none', border: 'none', color: '#E91E8C', fontSize: '14px', fontWeight: '600', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '4px' }}
                    >
                        {showExtra ? 'Lihat Lebih Sedikit' : 'Lihat Semua Layanan'}
                        <i className={`ti ti-chevron-${showExtra ? 'up' : 'down'}`}></i>
                    </button>
                </div>
            </div>

            {/* 3. FORM INPUT ANTREAN */}
